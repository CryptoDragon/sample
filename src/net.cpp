...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "samplecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"samplecoin.org", "dnsseed.samplecoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"samplecoin.org", "testnet-seed.samplecoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. samplecoin is probably already running."), addrBind.ToString().c_str());
        else
